...
init_native_log()
// 内置实验室地图已全部移除（改为从服务器在线下载，见 MapDownloadManager / OnlineMapGUI），
// 原 install_bundled_lab_stages() 及其清理助手 lab_delete_recursive_files() 已随之删除。
