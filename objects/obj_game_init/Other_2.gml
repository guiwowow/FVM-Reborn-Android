...
//{//测试版设置初始存档
//	unlock_card("toast_bread",0,0,0)
//	unlock_card("small_fire",0,0,0)
//	unlock_card("xiao_long_bao",0,0,0)
//	unlock_card("flour_sack",0,0,0)
//	unlock_card("double_long_bao",0,0,0)
//	unlock_card("mouse_clip",0,0,0)
//	unlock_card("coke_bomb",0,0,0)
//	unlock_card("wooden_plate",7,1,6)
//	unlock_card("ice_long_bao",0,0,0)
//	unlock_card("goblet_lamp",7,1,6)
//	unlock_card("coffee_cup",0,0,0)
//	unlock_card("salad_pult",0,0,0)
//	unlock_card("coffee_pot",0,0,0)
//	unlock_card("chocolate_bread",0,0,0)
//	unlock_card("water_tea_cup",0,0,0)
//	unlock_card("ice_bucket_bomb",0,0,0)
//	unlock_card("stinky_tofu_pult",0,0,0)
//	unlock_card("cat_box",0,0,0)
//	unlock_card("kettle_bomb",0,0,0)
//	unlock_card("fishbone",0,0,0)
//	unlock_card("triple_wine_rack",0,0,0)
//	unlock_card("brazier",0,0,0)
//	//unlock_card("large_fire",0,0,0)
//	//unlock_card("iron_fishbone",0,0,0)
//	//unlock_card("gatlin_long_bao",0,0,0)
//	//unlock_card("rotating_coffee_pot",0,0,0)
//	//unlock_card("takoyaki",12,2,7)
//	unlock_card("wine_bottle_bomb",0,0,0)
//	unlock_card("egg_boiler_pult",0,0,0)
//	unlock_card("double_water_pipe",0,0,0)
//	unlock_card("melon_shield",0,0,0)
//	//unlock_card("ice_egg_boiler_pult",0,0,0)
//	unlock_card("coffee_grounds",0,0,0)
//	unlock_card("hamburger",0,0,0)
//	unlock_card("steel_wool",0,0,0)
//	unlock_card("wooden_cork",0,0,0)
//	unlock_card("sausage",0,0,0)
//	unlock_card("oil_lamp",0,0,0)
//	unlock_card("ventilation_fan",0,0,0)
//	unlock_card("firework_dragon",0,0,0)
//	unlock_card("cherry_pudding",0,0,0)
//	unlock_card("double_ice_long_bao",0,0,0)
//	unlock_card("cat_chest",0,0,0)
//	unlock_card("chocolate_pult",0,0,0)
//	//unlock_card("chocolate_cannon",0,0,0)
//	unlock_card("skewer_bomb",0,0,0)
...
//	set_material_amount("natural_spices",1)
//	set_material_amount("secret_spices",5)
//	set_material_amount("royal_spices",999999999)
//	set_material_amount("clover_1",1)
//	set_material_amount("clover_2",5)
//	set_material_amount("clover_3",999999999)
//	set_material_amount("less_crystal",1)
//	set_material_amount("middle_crystal",5)
