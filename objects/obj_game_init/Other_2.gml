...
{//测试版设置初始存档
	...
	unlock_card("tar_sprayer",12,1,8)
	...
	unlock_card("pineapple_explosive_bread",12,1,8)
	unlock_card("ice_cream",12,1,8)
	unlock_card("lightning_baguette",12,1,8)
	...
	unlock_card("king_triple_long_bao",12,1,8)
	unlock_card("chili_powder",12,1,8)
	unlock_card("tang_hu_lu",12,1,8)
