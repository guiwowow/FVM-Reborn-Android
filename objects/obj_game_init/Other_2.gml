...
{//测试版设置初始存档
	...
	unlock_card("small_fire",12,1,7)
	unlock_card("xiao_long_bao",12,0,7)
	unlock_card("flour_sack",12,1,7)
	unlock_card("double_long_bao",12,0,7)
	unlock_card("mouse_clip",12,2,7)
	unlock_card("coke_bomb",12,1,7)
	unlock_card("wooden_plate",12,2,7)
	unlock_card("ice_long_bao",12,0,7)
	unlock_card("goblet_lamp",12,1,7)
	unlock_card("coffee_cup",12,2,7)
	unlock_card("salad_pult",12,1,7)
	unlock_card("coffee_pot",12,2,7)
	unlock_card("chocolate_bread",12,1,7)
	unlock_card("water_tea_cup",12,0,7)
	unlock_card("ice_bucket_bomb",12,1,7)
	unlock_card("stinky_tofu_pult",12,1,7)
	unlock_card("cat_box",12,0,7)
	unlock_card("kettle_bomb",12,1,7)
	unlock_card("fishbone",12,0,7)
	unlock_card("triple_wine_rack",12,1,7)
	unlock_card("brazier",12,1,7)
	unlock_card("large_fire",12,2,7)
	unlock_card("iron_fishbone",12,2,7)
	unlock_card("gatlin_long_bao",12,1,7)
	unlock_card("rotating_coffee_pot",12,1,7)
	unlock_card("takoyaki",12,1,7)
	unlock_card("wine_bottle_bomb",12,1,7)
	unlock_card("egg_boiler_pult",12,1,7)
	unlock_card("double_water_pipe",12,1,7)
	unlock_card("melon_shield",12,2,7)
	unlock_card("ice_egg_boiler_pult",12,2,7)
	unlock_card("coffee_grounds",12,2,7)
	unlock_card("hamburger",12,1,7)
	unlock_card("steel_wool",12,0,7)
	unlock_card("wooden_cork",12,0,7)
	unlock_card("sausage",12,0,7)
	unlock_card("oil_lamp",12,1,7)
	unlock_card("ventilation_fan",12,1,7)
	unlock_card("firework_dragon",12,1,7)
	unlock_card("cherry_pudding",12,1,7)
	unlock_card("double_ice_long_bao",12,0,7)
	unlock_card("cat_chest",12,0,7)
	unlock_card("chocolate_pult",12,1,7)
	unlock_card("chocolate_cannon",12,1,7)
	unlock_card("skewer_bomb",12,0,7)
	unlock_card("aquarius_elve",12,1,7)
	unlock_card("tar_sprayer",12,1,7)
	unlock_card("hotdog_cannon",12,1,7)
	unlock_card("triple_long_bao",12,0,7)
	unlock_card("triple_ice_long_bao",12,0,7)
	unlock_card("whisky_bomb",12,1,7)
	unlock_card("oden_pot",12,1,7)
	unlock_card("cotton_candy",12,1,7)
	unlock_card("dragon_fruit",12,1,7)
	unlock_card("durian",12,1,7)
	unlock_card("pineapple_explosive_bread",12,1,7)
	unlock_card("ice_cream",12,1,7)
	unlock_card("lightning_baguette",12,1,7)
	unlock_card("bull_firework",12,1,7)
	unlock_card("magic_chicken",0,0,0)
	unlock_card("xinjiang_fried_noodles",12,1,7)
	unlock_card("king_long_bao",12,1,7)
