...
{//测试版设置初始存档
	unlock_card("toast_bread",7,0,6)
	unlock_card("small_fire",7,0,6)
	unlock_card("xiao_long_bao",7,0,6)
	unlock_card("flour_sack",7,0,6)
	...
	unlock_card("chocolate_bread",7,0,6)
	unlock_card("water_tea_cup",7,0,6)
	unlock_card("ice_bucket_bomb",7,0,6)
	unlock_card("stinky_tofu_pult",7,0,6)
	unlock_card("cat_box",7,0,6)
	unlock_card("kettle_bomb",7,0,6)
	unlock_card("fishbone",7,0,6)
	unlock_card("triple_wine_rack",7,0,6)
	unlock_card("brazier",7,0,6)
	//unlock_card("large_fire",7,0,6)
	//unlock_card("iron_fishbone",7,0,6)
	//unlock_card("gatlin_long_bao",7,0,6)
	//unlock_card("rotating_coffee_pot",7,0,6)
	//unlock_card("takoyaki",12,2,7)
	unlock_card("wine_bottle_bomb",7,0,6)
	unlock_card("egg_boiler_pult",7,0,6)
	unlock_card("double_water_pipe",7,0,6)
	unlock_card("melon_shield",7,0,6)
	//unlock_card("ice_egg_boiler_pult",7,0,6)
	unlock_card("coffee_grounds",7,0,6)
	unlock_card("hamburger",7,0,6)
	unlock_card("steel_wool",7,0,6)
	...
	unlock_card("cherry_pudding",7,0,6)
	unlock_card("double_ice_long_bao",7,0,6)
	unlock_card("cat_chest",7,0,6)
	unlock_card("chocolate_pult",7,0,6)
	//unlock_card("chocolate_cannon",7,0,6)
