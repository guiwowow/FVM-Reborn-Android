function slots_init(){
	...
	register_card("coal_starfish", obj_coal_starfish, [
		...
		{"shape":2, "sprite":spr_coal_starfish_2, "cost":325, "cooldown":7*60, "description":"芥末海星刺身：向五个方向发射两颗星星","plant_type":"normal","feature_type":"amphi","target_card":"none"}
	]);
	register_card("curry_lobster_cannon", obj_curry_lobster_cannon, [
	    {"shape":0, "sprite":spr_curry_lobster_cannon, "cost":275, "cooldown":15*60, "description":"咖喱龙虾炮：发射两个追踪咖喱炮弹，陆地窒息","plant_type":"normal","feature_type":"amphi","target_card":"none"},
		{"shape":1, "sprite":spr_curry_lobster_cannon_1, "cost":275, "cooldown":15*60, "description":"麻辣龙虾炮：发射两个追踪咖喱炮弹","plant_type":"normal","feature_type":"amphi","target_card":"none"},
		{"shape":2, "sprite":spr_curry_lobster_cannon_2, "cost":275, "cooldown":15*60, "description":"加农龙虾炮：发射三个追踪咖喱炮弹","plant_type":"normal","feature_type":"amphi","target_card":"none"}
	]);
}